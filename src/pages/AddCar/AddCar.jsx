...
const AddCar = () => {
  ...
  return (
    <div className={style.addCar}>
      ...
      <ErrorPopUp active={errorPopUpActive} setActive={setErrorPopUpActive}
                  errorText={intl.formatMessage({ id: "add_error" })} />
      <h1><FormattedMessage id="add_head" /></h1>
      <div className={style.filter}>
        <AutoCompleteDropDown optionsData={brands} dropDownName={intl.formatMessage({ id: "filter_brand" })}
                              isAdd={true} setChosen={setSelectedBrandAC}
                              choseSpecAdd={choseSpecAdd} chosen={selectedBrand} />
        {selectedBrand ?
          <AutoCompleteDropDown optionsData={filterModels} dropDownName={intl.formatMessage({ id: "filter_model" })}
                                isAdd={true} setChosen={setSelectedModelsAC}
        ...
        <AutoCompleteDropDown optionsData={bodyTypes} dropDownName={intl.formatMessage({ id: "filter_body_type" })}
                              isAdd={true}
                              setChosen={setSelectedBodyTypeAC} choseSpecAdd={choseSpecAdd} chosen={selectedBodyType} />
        <AutoCompleteDropDown optionsData={driveUnits} dropDownName={intl.formatMessage({ id: "filter_drive_unit" })}
                              isAdd={true}
                              setChosen={setSelectedDriveUnitAC} choseSpecAdd={choseSpecAdd}
                              chosen={selectedDriveUnit} />
        <AutoCompleteDropDown optionsData={transmissions}
                              dropDownName={intl.formatMessage({ id: "filter_transmission" })} isAdd={true}
                              setChosen={setSelectedTransmissionAC} choseSpecAdd={choseSpecAdd}
                              chosen={selectedTransmission} />
        <AutoCompleteDropDown optionsData={steeringWheels}
                              dropDownName={intl.formatMessage({ id: "filter_steering_wheel" })} isAdd={true}
                              setChosen={setSelectedSteeringWheelAC} choseSpecAdd={choseSpecAdd}
                              chosen={selectedSteeringWheel} />
        <AutoCompleteDropDown optionsData={colors} dropDownName={intl.formatMessage({ id: "add_color" })} isAdd={true}
                              setChosen={setSelectedColorAC}
      ...
      <div className={style.spec}>
         <textarea placeholder={intl.formatMessage({ id: "add_description" })}
                   className={(specErrorSearch && selectedDescription === "") || selectedDescription.length > 255 ? style.descriptionInputError : style.descriptionInput}
