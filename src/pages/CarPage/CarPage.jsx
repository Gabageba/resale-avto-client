  ...
  return (
    <div>
      <div className={style.carPage}>
        <div>
          <img className={style.fullImg}
               src={selectedImage ? process.env.REACT_APP_API_URL + "/" + selectedImage : null}
               alt={car.model} />
          <div className={style.littleImg}>
            ...
            {img.length === 0 ? null
              : img.map(img => (
                <img src={process.env.REACT_APP_API_URL + "/" + img.img} key={img.id} alt={img.img}
