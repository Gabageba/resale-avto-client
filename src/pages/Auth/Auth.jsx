  ...
  return (
    <div>
      ...
      <div className={isLogin ? style.loginForm : style.registrationForm}>
        <h1 className={style.header}>{isLogin ? <FormattedMessage id="auth_login_head" /> :
          <FormattedMessage id="auth_reg_head" />}</h1>
        {isLogin ?
          <span></span>
          : <input type="text"
        ...
        <div>
          {isLogin ?
            <div className={style.link}><FormattedMessage id="auth_no_acc" /> <NavLink className={style.navigateLink}
                                                                                       ...
                                                                                       onClick={clear}><FormattedMessage
              id="auth_reg" /></NavLink></div>
            : <div className={style.link}><FormattedMessage id="auth_acc" /> <NavLink className={style.navigateLink}
                                                                                      to={LOGIN_ROUTE}
                                                                                      onClick={clear}><FormattedMessage
              id="auth_login" /></NavLink></div>
          }
        </div>
        {/*<div className={style.error}>Неверное имя пользователя или пароль</div>*/}
        <button className={style.sendButton} onClick={loginClick}>{isLogin ?
          <FormattedMessage id="auth_login_button" /> : <FormattedMessage id="auth_reg_button" />}</button>
      </div>
    </div>
